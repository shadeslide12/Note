...
QT_MOC_LITERAL(1, 14, 20), // "propertyValueChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 12), // "propertyName"
QT_MOC_LITERAL(4, 49, 8), // "newValue"
QT_MOC_LITERAL(5, 58, 13), // "onCellChanged"
QT_MOC_LITERAL(6, 72, 3), // "row"
QT_MOC_LITERAL(7, 76, 6) // "column"

    },
    "PropertyPanel\0propertyValueChanged\0\0"
    "propertyName\0newValue\0onCellChanged\0"
    "row\0column"
};
...
void PropertyPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->propertyValueChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QVariant(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PropertyPanel::propertyValueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PropertyPanel::propertyValueChanged(const QString & _t1, const QVariant & _t2)
{
